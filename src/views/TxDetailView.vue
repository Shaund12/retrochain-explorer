...
const events = computed<TxEventRow[]>(() => {
  ...
  // Decoded events for pretty-print display
  ...
  const eventCategories = computed(() => {
    ...
    return Object.keys(groups).filter((cat) => groups[cat as keyof typeof groups].length > 0);
  });
      ...
      <div class="lg:col-span-2">
        ...
        <div v-if="tx && viewMode==='pretty'" class="space-y-3">
          ...
          <div v-if="hasEvents" class="border-t border-slate-800 pt-3">
            ...
            <div v-if="viewMode === 'pretty'" class="space-y-3 max-h-[500px] overflow-auto pr-1">
              <div
            ...
            <div v-else class="max-h-80 overflow-auto pr-1 space-y-2">
              <div
